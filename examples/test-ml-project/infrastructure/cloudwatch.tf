# CloudWatch configuration for test-ml-project
# Generated by Geronimo

# Log Group
resource "aws_cloudwatch_log_group" "main" {
  name              = "/ecs/test-ml-project"
  retention_in_days = 30
}

# CloudWatch Dashboard
resource "aws_cloudwatch_dashboard" "main" {
  dashboard_name = "test-ml-project-${var.environment}"
...
resource "aws_cloudwatch_metric_alarm" "high_error_rate" {
  alarm_name          = "test-ml-project-high-error-rate"
...
resource "aws_cloudwatch_metric_alarm" "high_latency" {
  alarm_name          = "test-ml-project-high-latency"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = 2
