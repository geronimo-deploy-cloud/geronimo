"""FastAPI application for credit-risk ML serving."""
...
from credit_risk.api.routes import health, predict
from credit_risk.ml.predictor import ModelPredictor
...
from credit_risk.api import deps
from credit_risk.agent.server import mcp
...
metrics = MetricsCollector(project_name="credit-risk")
