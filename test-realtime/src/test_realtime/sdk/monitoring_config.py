...
import os
from test_realtime.monitoring.alerts import AlertManager, SlackAlert, AlertSeverity
...
def check_thresholds(metrics: MetricsCollector, alerts: AlertManager) -> None:
    ...
    Example:
        ...
        from test_realtime.sdk.monitoring_config import (
            create_alert_manager, check_thresholds
        )
        from test_realtime.monitoring.metrics import metrics
